                        ...
                        <div class="row">
                            <article class="post-item">
                                ...
                                <div class="post-meta mt-4">
                                    <span class="post-category">${blog.updatedDate}</span> - 
                                    <span class="meta-date">
                                        <a href="blog.html">${blog.category}</a>
                                    </span>
                                </div>
                                ...
                                <div class="post-description review-item mt-4">
                                    ...
                                    <img src="${blog.thumbnail}" alt="post-image" class="img-fluid float-start rounded-4 me-3 mb-3 col-md-5">
