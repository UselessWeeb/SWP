                                ...
                                <div class="row post-contents">
                                        ...
                                        <c:forEach var="blog" items="${list}">
                                            <div class="col-lg-4 col-md-6 posts mb-4">
                                                ...
                                                <img src="images/${blog.img}" alt="post image" class="img-fluid">
                                                <h4 class="card-title mt-3 mb-2 text-uppercase text-dark">
                                                    <a href="single-post.html?id=${blog.idBlog}">${blog.header}</a>
                                                </h4>
                                                <p class="mb-2">${blog.description}</p>
                                                <a class="text-decoration-underline" href="single-post.html?id=${blog.idBlog}">Read More</a>
                                            </div>
                                        </c:forEach>
                                </div>
