 ...
 * @author M7510
 */
@WebServlet(name = "generalFeedback", urlPatterns = {"/generalFeedback"})
public class generalFeedback extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Feedback> feedbacks = feedbackDAO.getAllGeneralFeedback();
        ...
        request.getRequestDispatcher("view/customer-review.jsp").include(request, response);
    }
